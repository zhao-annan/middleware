...
import (
	...
	service2 "github.com/zhao-annan/middleware/domain/service"
	"github.com/zhao-annan/middleware/handler"
	middleware "github.com/zhao-annan/middleware/proto/middleware"
	"k8s.io/client-go/kubernetes"
	"k8s.io/client-go/tools/clientcmd"
	"k8s.io/client-go/util/homedir"
	//hystrix2 "git.imooc.com/zhao-annan/middleware/plugin/hystrix"
	"strconv"
)
